document.addEventListener('DOMContentLoaded', () => {
   ...
   const contentSearch = {
      ru: {
         ...
         about_me_3: 'Для ускорения процесса верстки использую сборщик Gulp.</br>С помощью этого инструмента автоматизирую многие процессы:',
         ...
         about_me_4: 'При написании классов руководствуюсь методологией BEM.</br>Для построения сеток использую Flex css или Grid css, если на проекте не используется Bootstrap.',
         about_me_5: 'При создании анимаций использую библиотеку Gsap, а также @keyframes css.',
      ...
      en: {
         ...
         about_me_3: 'To speed up the layout process, I use Gulp.</br>With this tool, I automate many processes:',
         ...
         about_me_4: 'When writing classes, I am guided by the BEM methodology.</br>To build grids, I use Flex css or Grid css if the project does not use Bootstrap.',
         about_me_5: 'When creating animations, I use the Gsap library, as well as @keyframes css.',
